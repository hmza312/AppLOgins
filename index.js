...
//   const authUrl = `https://open-api.tiktok.com/platform/oauth/connect?client_key=${TIKTOK_CLIENT_ID}&state=${state}&response_type=code&scope=user.info.basic&redirect_uri=${encodeURIComponent(
//     REDIRECT_URI_TITOK
//   )}`;
...
//     res.send(`<h1>Hello ${profile.display_name}</h1>`);
//   } catch (error) {
//     console.error(error);
